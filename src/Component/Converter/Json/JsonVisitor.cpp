...
namespace Json {
    ...
    void QJsonObject::visit(const MotherBoard& motherboard) {
    ...
    void QJsonObject::visit(const CPU& cpu) { 
    ...
    void QJsonObject::visit(const GPU& gpu) {
    ...
    void QJsonObject::visit(const PSU& psu) {
    ...
    void QJsonObject::visit(const RAM& ram) {
